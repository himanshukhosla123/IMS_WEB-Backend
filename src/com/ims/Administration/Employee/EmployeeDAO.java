...
//import static com.ims.Common.sqlQueries.ISqlQueries.UPDATE_EMPLOYEE;
	  ...
	  PreparedStatement psmt = null;
       public boolean addEmployee(EmployeeDTO employeeDTO) throws ClassNotFoundException, SQLException {
		  ...
		  try {
			  ...
			  psmt = con.prepareStatement(ADD_EMPLOYEE);
			    psmt.setString(1,employeeDTO.getEmpid());
       ...
       public ArrayList<EmployeeDTO> readEmployee() throws ClassNotFoundException, SQLException{
    	   ArrayList<EmployeeDTO> empList = new ArrayList<>();
    	    ...
    	    try {
    	    	...
    	    	while(rs.next()) {
    	    		EmployeeDTO emp = new EmployeeDTO(rs.getString(1),rs.getString(2),rs.getString(3)
       ...
       public boolean updateEmployee(EmployeeDTO employeeDTO) throws ClassNotFoundException, SQLException {
		try {
			...
			psmt.setString(14,employeeDTO.getEmpid());
